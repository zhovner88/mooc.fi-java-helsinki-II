...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        VehicleRegister vehicleRegistertest = new VehicleRegister();
        vehicleRegistertest.add(reg1, "Denys");
        vehicleRegistertest.printOwners();
        vehicleRegistertest.printRegistrationPlates();
    }
}
